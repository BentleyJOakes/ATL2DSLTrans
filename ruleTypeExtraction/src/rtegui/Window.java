...
//		this.setResizable(false);
	...
	public void getSMClick() {
		try{
			...
			System.out.println("pathSrcEcoreMMFile: " + pathSrcEcoreMMFile);
			System.out.println("pathTrgEcoreMMFile: " + pathTrgEcoreMMFile);
			System.out.println("pathATLTransformation: " + pathATLTransformation);
			System.out.println("pathOUTFile: " + pathOUTFile);
